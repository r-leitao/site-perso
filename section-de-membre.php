            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="row">
                  ...
                  <ul>
                    <li>Arrêter l'hémorragie immédiatement ; </li> 
                    <li>réaliser un pansement compressif sur le 
                    moignon en l'absence de saignement ; </li> 
                    <li>compléter le bilan d'urgence vitale, si 
                    nécessaire ; </li> 
                    <li>luter contre la détresse circulatoire ; </li> 
                    <li>réaliser un bilan complémentaire à la recher-
                    che d'autres signes ou lésions et réaliser les 
                    gestes de secours nécessaire ; </li> 
                    <li>demander un avis médical en transmeFant le 
                    bilan ; </li> 
                    <li>conditionner le membre sectionné ; </li> 
